...
struct TabIcon: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            if navLocationServices.selectedTab == tab {
                if tab == .froop {
                    ...
                    Image(systemName: imageName)
                        .font(.system(size: 28))
                        .fontWeight(.regular)
                        .foregroundColor(navLocationServices.selectedTab == tab ? Color(red: 249/255, green: 0/255, blue: 98/255) : Color(red: 50/255, green: 46/255, blue: 62/255))
                        .frame(width: 30, height: 30)
                }
            } else {
                if navLocationServices.selectedTab == .froop {
                    Image(froopImageName)
                        .resizable()
                        .scaledToFit()
                        .frame(width: 30, height: 30)
